...
@interface JZAudioQueueManager()<AVAudioRecorderDelegate>

@end

@implementation JZAudioQueueManager

+ (instancetype)shareInstance
{
    static JZAudioQueueManager *audioQueueManager = nil;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        audioQueueManager = [[JZAudioQueueManager alloc] init];
    });
